    ...
    <AppShell userName={user.name} roles={roleKeys}>
      <section className="panel substitutions-panel">
        ...
        {activeTab === "gerir" ? (
          ...
          <>
            <div className="substitution-list-header">
              <h2>Futuras substituições de todos os professores</h2>
              <p className="muted">Mostra quem está previsto substituir aulas nos dias atuais e futuros.</p>
            </div>
            <div className="substitution-request-list">
              {allFutureSubstitutions.length === 0 ? <p className="muted">Sem substituições futuras registadas.</p> : null}
